...
namespace CursoUdemyWebAPI.Servicios
{
    public class ServicioEmpleado : IServicioEmpleado
    {
        ...
        {
            new Empleado {Id = 1, Nombre = "Carlos", CodEmpleado = "A001", Email = "mail1@mail.es", Edad = 45, FechaAlta = DateTime.Now, FechaBaja = null},
            new Empleado {Id = 1, Nombre = "Juan", CodEmpleado = "A010", Email = "mail2@mail.es", Edad = 36, FechaAlta = DateTime.Now, FechaBaja = null},
            new Empleado {Id = 1, Nombre = "Manolo", CodEmpleado = "B017", Email = "mail3@mail.es", Edad = 27, FechaAlta = DateTime.Now, FechaBaja = null},
            new Empleado {Id = 1, Nombre = "Pedro", CodEmpleado = "A071", Email = "mail4@mail.es", Edad = 54, FechaAlta = DateTime.Now, FechaBaja = null},
        };
